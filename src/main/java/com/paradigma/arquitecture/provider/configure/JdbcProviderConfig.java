...
import com.paradigma.arquitecture.provider.userdetails.service.JdbcUserDetailsService;

@ConditionalOnMissingBean(AbstractProviderConfig.class)
@Configuration
public class JdbcProviderConfig implements AbstractProviderConfig {
	...
	public UserDetailsService userDetailsService() {
		return new JdbcUserDetailsService(cacheManager);
	}
